...
*
* gwxdy( x.length, arraylike2object( toAccessorArray( x ) ), 1, 0, arraylike2object( toAccessorArray( y ) ), 1, 0, arraylike2object( toAccessorArray( w ) ), 1, 0 );
* // w => [ 2.0, 2.0, 3.0, 4.0, 5.0 ]
*/
function gwxdy( N, x, strideX, offsetX, y, strideY, offsetY, w, strideW, offsetW ) { // eslint-disable-line max-len
	var xbuf;
	var ybuf;
	var wbuf;
	var xget;
